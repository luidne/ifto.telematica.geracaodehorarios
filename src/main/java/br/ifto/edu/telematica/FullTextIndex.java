package br.ifto.edu.telematica;
...
public class FullTextIndex {
    ...
    public void index(@Name("nodeId")long nodeId, @Name(value = "properties", defaultValue = "[]") List<String> propKeys) {
    ...
    public String indexName(String label) {
        return "label-"+label;
    }
}
